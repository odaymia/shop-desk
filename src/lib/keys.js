...
export const SYMPTOMREQ_KEY = "sd:symptomreq"; // a ticket sent to the pad for the customer to pick their symptoms (the concern)
export const SYMPTOMRESULT_PREFIX = "sd:symptomresult:"; // the concern the customer built on the pad, merged back onto the ticket
export const symptomResultKey = (orderId) => SYMPTOMRESULT_PREFIX + orderId;
